%% Function to pre-compute signalling constants:
% Constants for Heijman2011
%
% Adapted from Doste et al. https://www.mdpi.com/2227-7390/9/15/1785
% itself adapted from:  https://github.com/JQXGong/Ohara-beta-adrenergic
%
...
%% Cell geometry
length = 0.1;% Cell length
radius = 0.01025;% Cell radius
volume =  pi * radius * radius * length;% Cell volume
